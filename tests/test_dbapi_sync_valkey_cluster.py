"""Sync DB-API 2.0 tests with Valkey cluster lock.

Tests the rqlite Connection/Cursor (sync) using ValkeyLock with cluster=True
for distributed locking against a Valkey cluster.
...
TABLE = "dbapi_sync_valkey_cluster_test"


def _make_lock(name: str = "dbapi_sync_cluster") -> ValkeyLock:
...
class TestSyncDBAPI_Cluster_Connection:
    """Sync DB-API connection tests with ValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestSyncDBAPI_Cluster_CRUD:
    """Sync DB-API CRUD operations with ValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestSyncDBAPI_Cluster_Fetch:
    """Sync DB-API fetch method tests with ValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestSyncDBAPI_Cluster_Types:
    """Sync DB-API type handling tests with ValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestSyncDBAPI_Cluster_Errors:
    """Sync DB-API error handling tests with ValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestSyncDBAPI_Cluster_Workflow:
    """Sync DB-API complex workflow tests with ValkeyLock (cluster=True)."""
