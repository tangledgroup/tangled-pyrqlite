"""Async DB-API 2.0 tests with Valkey cluster lock (AioValkeyLock).

Tests the rqlite AsyncConnection/AsyncCursor using AioValkeyLock with
cluster=True for distributed locking against a Valkey cluster.
...
TABLE = "dbapi_async_valkey_cluster_test"


def _make_lock(name: str = "dbapi_async_cluster") -> AioValkeyLock:
...
class TestAsyncDBAPI_Cluster_Connection:
    """Async DB-API connection tests with AioValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestAsyncDBAPI_Cluster_CRUD:
    """Async DB-API CRUD operations with AioValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestAsyncDBAPI_Cluster_Fetch:
    """Async DB-API fetch method tests with AioValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestAsyncDBAPI_Cluster_Types:
    """Async DB-API type handling tests with AioValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestAsyncDBAPI_Cluster_Errors:
    """Async DB-API error handling tests with AioValkeyLock (cluster=True)."""
...
@skip_if_no_valkey_cluster
class TestAsyncDBAPI_Cluster_Workflow:
    """Async DB-API complex workflow tests with AioValkeyLock (cluster=True)."""
